...
from quantum.shared.web3.clients.websocket_manager import WebSocketManager, get_websocket_manager
...
from quantum.shared.web3.hooks.signal_dispatcher import (
    SignalDispatcher,
    IntegrationMode,
    Web3Signal,
...
from quantum.shared.web3.hooks.event_bus import EventBus, Event, EventPriority, get_event_bus
from quantum.shared.web3.models.mempool_types import WhaleAlert, MempoolSignal
from quantum.shared.web3.models.correlation_types import CrossChainIndex, CorrelationEvent
...
class Web3IntelligenceEngine:
    ...
    ======
    ```python
    from quantum.shared.web3 import Web3IntelligenceEngine
